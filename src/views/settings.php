        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                <ul class="list-unstyled accordion-menu">
                    ...
                    <li>
                        <a href="./settings.php" style="color: #118ab2 !important;"><i data-feather="tool" style="color: #118ab2 !important;"></i><?= $t['main_settings'] ?></a>
                    </li>
                    <li class="sidebar-title">
                        <?= $t['pro_functions'] ?>
                    </li>
                ...
                <div class="main-wrapper">
                    <div class="qr-section">
                        <div class="qr-header">
                            ...
                            <div>
                                <h1 class="language-title"><?= $t['settings_title'] ?></h1>
                            </div>
                        </div>
                    ...
                    <form id="settingsForm">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="upload-area" onclick="document.getElementById('logoUpload').click()">
                                            ...
                                            <div class="upload-text">
                                                <?= $t['upload_logo_text'] ?><br>
                                                <small><?= $t['logo_dimensions_hint'] ?></small>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="upload-area" onclick="document.getElementById('bannerUpload').click()">
                                            ...
                                            <div class="upload-text">
                                                <?= $t['upload_banner_text'] ?><br>
                                                <small><?= $t['banner_dimensions_hint'] ?></small>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="restaurantName" placeholder="<?= $t['restaurant_name_placeholder'] ?>" value="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" id="currency">
                                            <option value="EUR" selected><?= $t['currency_euro'] ?></option>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="wifiName" placeholder="<?= $t['wifi_name_placeholder'] ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label"><?= $t['wifi_password_label'] ?></label>
                                        <input type="text" class="form-control" id="wifiPassword" placeholder="<?= $t['wifi_password_placeholder'] ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="address" rows="3" placeholder="<?= $t['address_placeholder'] ?>"></input>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label"><?= $t['phone_number_label'] ?></label>
                                        <input type="tel" class="form-control" id="phone" placeholder="<?= $t['phone_number_placeholder'] ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="instagram" placeholder="<?= $t['instagram_placeholder'] ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="url" class="form-control" id="facebook" placeholder="<?= $t['facebook_placeholder'] ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="settings-category">
                            ...
                            <div class="day-schedule">
                                <div class="day-name"><?= $t['monday'] ?></div>
                                ...
                                <div class="time-inputs">
                                    ...
                                    <div>
                                        ...
                                        <input type="time" class="form-control time-input" value="22:00">
                                    </div>
                                </div>
                            </div>

                            <div class="day-schedule">
                                <div class="day-name"><?= $t['tuesday'] ?></div>
                                <div class="day-toggle">
                                    <label class="toggle-switch">
                            ...
                            <div class="day-schedule">
                                <div class="day-name"><?= $t['wednesday'] ?></div>
                                <div class="day-toggle">
                                    <label class="toggle-switch">
                            ...
                            <div class="day-schedule">
                                <div class="day-name"><?= $t['thursday'] ?></div>
                                <div class="day-toggle">
                                    <label class="toggle-switch">
                            ...
                            <div class="day-schedule">
                                <div class="day-name"><?= $t['friday'] ?></div>
                                <div class="day-toggle">
                                    <label class="toggle-switch">
                            ...
                            <div class="day-schedule">
                                <div class="day-name"><?= $t['saturday'] ?></div>
                                <div class="day-toggle">
                                    <label class="toggle-switch">
                            ...
                            <div class="day-schedule">
                                <div class="day-name"><?= $t['sunday'] ?></div>
                                <div class="day-toggle">
                                    <label class="toggle-switch">
        ...
        <script>
            ...
            document.getElementById('logoUpload').addEventListener('change', function(e) {
                ...
                if (file) {
                    ...
                    reader.onload = function(e) {
                        preview.innerHTML = `<img src="${e.target.result}" alt="Logo Preview" style="width: 100%; height: 100%; object-fit: cover; border-radius: 6px;">`;
                    };
            ...
            document.getElementById('bannerUpload').addEventListener('change', function(e) {
                ...
                if (file) {
                    const reader = new FileReader();
                    reader.onload = function(e) {
                        preview.innerHTML = `<img src="${e.target.result}" alt="Banner Preview" style="width: 100%; height: 100%; object-fit: cover; border-radius: 6px;">`;
                    };
                    reader.readAsDataURL(file);
                }
            });
            ...
            const dayToggles = ['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'];
            
            dayToggles.forEach(day => {
                const toggle = document.getElementById(day);
                const timeInputs = toggle.closest('.day-schedule').querySelector('.time-inputs');
            ...
            function handleResize() {
                if (window.innerWidth <= 768) {
                    document.querySelector('.page-sidebar').style.transform = 'translateX(-100%)';
                    const content = document.querySelector('.page-content');
                    content.style.marginLeft = '0';
                    content.style.width = '100%';
                }
